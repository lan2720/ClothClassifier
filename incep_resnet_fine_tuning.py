...
model_name = 'resnet_fine_tuning_8clf_'
...
gen_train = Generator(X_train, y_train, batch_size=2, aug=True)
...
#get_ipython().run_cell_magic('bash', '-s $fname_csv $fname_zip', 'rm $2\nzip $2 $1')
